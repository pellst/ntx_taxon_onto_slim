These notes are for the EDITORS of ntx
...
Make sure you have an ID range in the [idranges file](ntx-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [ntx-edit.owl](ntx-edit.owl)

** DO NOT EDIT ntx.obo OR ntx.owl in the top level directory **

[../../ntx.owl](../../ntx.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/pellst/ntx) for details.
 ...
 * [ntx-idranges.owl](ntx-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/ntx_terms.txt file
...
Note: the ntx_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as ntx.owl and ntx.obo and places
 ...
 * https://github.com/pellst/ntx/releases
 * https://github.com/pellst/ntx/releases/new
...
what is in the `owl:versionIRI` of the derived ntx.owl (`data-version` in
ntx.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/ntx.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/ntx/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/pellst/ntx.svg?branch=master)](https://travis-ci.org/pellst/ntx)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/pellst](https://travis-ci.org/profile/pellst)
 2. click the "Sync account" button
 3. Click the tick symbol next to ntx
